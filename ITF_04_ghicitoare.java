...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (numar_ghicit != numar_secret){ // atat timp cat inca nu s-a ghicit nr, continua jocul
            ...
            if (numar_ghicit == numar_secret){ // daca numarul este acelasi
                System.out.println("Felicitari"); // jucatorul castiga
            } else if (numar_ghicit < numar_secret){ // altfel, daca nr_ghicit < nr, dam un indiciu jucatorului
